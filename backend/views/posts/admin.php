...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
					'name' => 'stick',
					'value' => '($data->stick === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
		...
		array(
					'name' => 'home_page',
					'value' => '($data->home_page === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
		array(
					'name' => 'type',
		...
		array(
					'name' => 'read_all',
					'value' => '($data->read_all === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
		array(
					'name' => 'read',
					'value' => '($data->read === 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
		array(
					'name' => 'status',
